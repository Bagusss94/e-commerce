...
<div class="card card-primary card-outline">
  ...
  <div class="card-body">
    ...
    <?= form_open_multipart(""); ?>
    <input type="hidden" name="role" id="role" value="<?= $dataUser['role']; ?>" readonly>
    <div class="form-group">
      <label for="email">E-mail</label>
      <input type="text" name="email" id="email" class="form-control" value="<?= old('email') ? old('email') : $dataUser['email']; ?>" autofocus>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" name="nama_lengkap" id="nama_lengkap" class="form-control" value="<?= old('nama_lengkap') ? old('nama_lengkap') : $dataUser['nama_lengkap']; ?>">
    </div>
    <div class="form-group">
      ...
      <div class="input-group">
        ...
        <input type="text" name="telp" id="telp" class="form-control" data-inputmask='"mask": "(62) 9999-9999-9999"' data-mask value="<?= old('telp') ? old('telp') : $dataUser['telp']; ?>">
      </div>
    </div>
    <div class="form-group row row-img">
      <div class="col-lg-3">
        <img src="<?= base_url("images/" . $dataUser['foto_profil']); ?>" style="width: 100%;" class="img-thumbnail img-preview">
      </div>
      <div class="col-lg-9">
