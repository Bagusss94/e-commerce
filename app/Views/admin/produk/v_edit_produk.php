...
<div class="card card-primary card-outline">
  ...
  <div class="card-body">
    ...
    <div class="form-group">
      ...
      <input type="text" name="nama_produk" id="nama_produk" class="form-control" value="<?= old('nama_produk') ? old('nama_produk') : $dataProduk['nama_produk']; ?>" autofocus>
    </div>
    <div class=" form-group">
      <label for="harga_produk">Harga Produk (Rp)</label>
      <input type="number" name="harga_produk" id="harga_produk" class="form-control" value="<?= old('harga_produk') ? old('harga_produk') : $dataProduk['harga_produk']; ?>">
    </div>
    <div class="form-group">
      <label for="stok">Stok Produk</label>
      <input type="number" name="stok" id="stok" class="form-control" value="<?= old('stok') ? old('stok') : $dataProduk['stok']; ?>">
    </div>
    <div class="form-group">
      ...
      <select name="id_satuan" id="id_satuan" class="form-control">
        ...
        <?php foreach ($satuan as $s) : ?>
          ...
          <?php } else { ?>
            <option value="<?= $s['id_satuan'] ?>" <?= $dataProduk['id_satuan'] == $s['id_satuan'] ? 'selected' : ''; ?>><?= $s['satuan'] ?></option>
          <?php } ?>
        <?php endforeach; ?>
      </select>
    </div>
    <div class="form-group">
      ...
      <select name="id_kategori" id="id_kategori" class="form-control">
        ...
        <?php foreach ($kategori as $s) : ?>
          ...
          <?php } else { ?>
            <option value="<?= $s['id_kategori'] ?>" <?= $dataProduk['id_kategori'] == $s['id_kategori'] ? 'selected' : ''; ?>><?= $s['kategori'] ?></option>
          <?php } ?>
        <?php endforeach; ?>
      </select>
    </div>
    <div class=" form-group">
      ...
      <input type="number" name="berat" id="berat" class="form-control" value="<?= old('berat') ? old('berat') : $dataProduk['berat']; ?>">
    </div>
    <div class=" form-group">
      <label for="deskripsi_produk">Deskripsi Produk</label>
      <textarea name="deskripsi_produk" class="form-control summernote" id="deskripsi_produk"><?= old('deskripsi_produk') ? old('deskripsi_produk') : $dataProduk['deskripsi_produk']; ?></textarea>
    </div>
    <div class="form-group">
